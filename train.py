...
parser.add_argument('--root_path', type=str,
                    default='/mnt/data3/chai/SAM/SAMed_h/train_npz_new_224', help='root dir for data')
parser.add_argument('--output', type=str, default='/mnt/data3/chai/SAM/SAMed-main/results')
parser.add_argument('--dataset', type=str,
                    default='Synapse', help='dataset_name')
parser.add_argument('--experiment', type=str,
                    default='LST_only_SAM', help='experiment_name')
